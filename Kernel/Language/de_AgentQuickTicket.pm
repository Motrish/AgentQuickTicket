...
sub Data {
    ...
    my %Translation = (
        ...
        'Add separator before this profile' => 'Trennlinie vor diesem Profil hinzufügen',
        'Remove separator before this profile' => 'Trennlinie vor diesem Profil entfernen',
        'Show a separator before this profile' => 'Trennlinie vor diesem Profil anzeigen',
        'The separator is shown between visible profiles in AgentTicketPhone. It is never shown before the first visible profile.' => 'Die Trennlinie wird in AgentTicketPhone zwischen sichtbaren Profilen angezeigt. Vor dem ersten sichtbaren Profil wird sie nie angezeigt.',
        'group(s)' => 'Gruppe(n)',
